...
export default function Page() {
    ...
    return (
        <div className="mt-[40px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div className="flex items-center gap-4">
                        <Image
                            ...
                            width="100"
                            height="100"
                            className="w-[100px] group-hover:w-36 group-hover:h-36 h-[100px] object-center object-cover rounded-full transition-all duration-500 delay-500 transform"
                        />
                        <div className="w-fit transition-all transform duration-500 space-y-2">
                            <h1 className="text-gray-600 dark:text-gray-200 font-bold">
                                {user?.firstName} {user?.lastName}
                            </h1>
                            <p className="text-gray-400 text-sm">Username : {user?.firstName}</p>
                            <p className="text-gray-400 text-sm">Joing Date : {relativeDate(new Date(user?.createdAt ?? new Date()))}</p>
                            <a
                            ...
                            <Card className="min-w-[100px] sm:max-w-full py-4 px-8 shadow-lg group transform transition duration-500 hover:scale-[1.2] hover:z-50" key={book.id}>
                                <div className="flex justify-start items-center space-x-8">
                                    ...
                                    <div className="flex flex-col items-start space-y-[5px] sm:max-w-[140px]">
                                        ...
                                        <span className="text-xs text-gray-500">Price: <span className="text-black">{book.price} $</span></span>
                                        <span className="">
                                            <PercentageToStars
