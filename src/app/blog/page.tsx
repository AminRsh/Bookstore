                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    <div className="relative group ">
                        ...
                        justify-center items-center inset-0 top-[100%] transition-[top] duration-300 backdrop-blur-sm p-6 z-20">
                            <Button variant="outline" className="bg-transparent text-white rounded-none border-2" size="lg">Read More</Button>
                        </div>
                    </div>
                    <div className="relative group">
                    ...
                    <div className="relative group">
                        ...
                        justify-center items-center inset-0 top-[100%] transition-[top] duration-300 backdrop-blur-md p-6 z-20">
                            <Button variant="outline" className="bg-transparent text-black rounded-none border-2 border-black" size="lg">Read More</Button>
                        </div>
                    </div>
                    <div className="relative group">
